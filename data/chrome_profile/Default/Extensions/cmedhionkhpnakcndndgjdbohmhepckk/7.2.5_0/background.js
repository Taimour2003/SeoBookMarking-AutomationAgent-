...
var handleSetSetting = function (payload) { return listen_messages_awaiter(void 0, void 0, void 0, function () {
    return listen_messages_generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, setToStorageAndSettings(payload.key, payload.value)];
            case 1:
                _a.sent();
                return [2, { ok: true }];
        }
    ...
    return update_settings_from_server_generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4, wait(CONFIG_FETCH_RETRY_DELAY_MS * attempt)];
            case 3:
                _a.sent();
                _a.label = 4;
            case 4:
...
var updateSettingsFromServer = function () { return update_settings_from_server_awaiter(void 0, void 0, void 0, function () {
    var lastRulesFetchAt, msSinceLastFetch, isCacheFresh, isAppVersionChanged, response, networkRules, cssRules, popupConfig, scripletsRules, updatePageConfig, data;
    var _a;
    return update_settings_from_server_generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4, getFromChromeStorage(ExtensionsKeys.LastRulesFetchAt)];
            case 1:
                ...
                if (isCacheFresh && !isAppVersionChanged) {
                    return [2];
                }
            ...
            case 2:
                ...
                data = (_a = {},
                    ...
                    _a[SettingsKeys.PopupConfig] = popupConfig !== null && popupConfig !== void 0 ? popupConfig : DefaultPopupsConfig,
                    _a);
            ...
            case 4:
                _b.sent();
                return [4, tryOpenUpdatePage(updatePageConfig)];
            case 5:
                _b.sent();
                return [2];
        }
...
var tryOpenPendingUpdatePage = function () { return update_settings_from_server_awaiter(void 0, void 0, void 0, function () {
    var updatePagePending, informAboutUpdates, e_2;
    var _a, _b;
    return update_settings_from_server_generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, consumeStartupWake()];
            case 1:
                if (!(_c.sent())) {
                    return [2];
                }
            ...
            case 2:
                _c.trys.push([2, 9, , 10]);
                return [4, getFromChromeStorage(ExtensionsKeys.UpdatePagePending)];
            case 3:
                updatePagePending = _c.sent();
                if (!updatePagePending) {
                    return [2];
                }
                return [4, getFromChromeStorage(SettingsKeys.InformAboutUpdates)];
            case 4:
                informAboutUpdates = _c.sent();
                if (!(informAboutUpdates === false)) return [3, 6];
                return [4, setMultipleToChromeStorage((_a = {},
                        _a[ExtensionsKeys.UpdatePagePending] = false,
                        _a[ExtensionsKeys.ShouldCheckUpdatePageConfig] = false,
                        _a))];
            case 5:
                _c.sent();
                return [2];
            case 6: return [4, createTab(UPDATE_URL)];
            case 7:
                _c.sent();
                return [4, setMultipleToChromeStorage((_b = {},
                        _b[ExtensionsKeys.UpdatePagePending] = false,
                        _b[ExtensionsKeys.ShouldCheckUpdatePageConfig] = false,
                        _b))];
            case 8:
                _c.sent();
                return [3, 10];
            case 9:
                e_2 = _c.sent();
                console.error('open pending update page failed:', e_2);
                return [3, 10];
            case 10: return [2];
        }
    });
